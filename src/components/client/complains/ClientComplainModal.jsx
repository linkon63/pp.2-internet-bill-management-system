...
export default function ClientComplainModal({ isOpen, closeModal, onSubmitClient, setLoading, register, handleSubmit, reset, refetch }) {

    const modalDisplayStyle = isOpen ? 'block' : 'hidden';
